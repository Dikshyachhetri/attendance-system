                ...
                <Col lg={10} className="not-body">
                    ...
                    <Row className="employee-body">
                        <Col className="d-flex flex-row p-0">
                            <div className="dropdown-row flex-all">
                    ...
                    <Row>
                        <Col className="cards">
                            ...
                            <div class="card flex-all">
                                <img className="card-img" src="/images/card-image.svg"></img>
                                <div class="card-body flex-all flex-column">
                                    <h5 className="card-title">Eren Yeager</h5>
                                    <p className="card-text">UI/UX Designer</p>
                                    <p className="card-text2"><img className="phone-icon" src="/images/phone-icon.svg"></img>9854545454</p>
                                    <p className="card-text3">eren@ftebs.com</p>
                                </div>
                            </div>
